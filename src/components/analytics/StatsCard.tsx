...
const StatsCard = ({ title, value, icon: Icon, gradientFrom, gradientTo }: StatsCardProps) => {
  return (
    <Card className="bg-white/5 backdrop-blur-sm border-0 shadow-md hover:shadow-lg transition-shadow overflow-hidden">
      <CardContent className={`pt-6 rounded-lg relative group transition-colors bg-gradient-to-br ${gradientFrom} ${gradientTo}`}>
