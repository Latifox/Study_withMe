...
const TechPartnersSection = () => {
  ...
  const partners: PartnerLogo[] = [
    ...
    {
      name: "Perplexity",
      image: "/lovable-uploads/9f0e116f-f4dd-419f-903f-820f5ad56e08.png",
      alt: "Perplexity Logo"
    }, 
    {
      name: "Grok",
      image: "/lovable-uploads/cb7788ae-2e82-482c-95a3-c4a34287fa9a.png",
      alt: "X.ai Logo"
    }, 
    {
      name: "MistralAI",
      image: "/lovable-uploads/5e7d57a9-e929-4995-8863-537f267089dc.png",
      alt: "MistralAI Logo"
    }, 
    {
      name: "Anthropic",
      image: "/lovable-uploads/a21a04a4-1298-4d9f-ae4f-4431e76715d5.png",
      alt: "Anthropic Logo"
    }, 
    {
      name: "Landing.ai",
      image: "/lovable-uploads/52af45c5-9ce8-4340-8ed7-afe53be65e34.png",
      alt: "Landing.ai Logo"
    }
  ];
              ...
              <Card className="w-full h-24 hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-4 flex items-center justify-center h-full">
                  <img 
                    ...
                    onError={(e) => {
                      e.currentTarget.src = "https://via.placeholder.com/150?text=" + encodeURIComponent(partner.name);
