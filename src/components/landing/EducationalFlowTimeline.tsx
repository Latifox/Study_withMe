      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative z-10">
          {timelineSteps.map((step, index) => (
            ...
            >
              <motion.div
                className="w-16 h-16 rounded-full bg-gradient-to-b from-blue-400 to-blue-600 flex items-center justify-center mb-3"
              ...
              {index < timelineSteps.length - 1 && (
                <motion.div
                  className="absolute top-24 transform -translate-y-1/2 hidden md:block"
                  style={{ 
                    left: `${(index * 20) + 16}%`, 
                    width: '8%' 
                  }}
