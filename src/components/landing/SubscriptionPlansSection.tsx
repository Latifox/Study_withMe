...
const SubscriptionPlansSection = () => {
  ...
  const subscriptionPlans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Advanced lecture summaries",
        "Expert-level quiz generation",
        "Unlimited flashcards with analytics",
      ],
      ctaText: "Choose Plan",
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-16 relative" ref={sectionRef}>
      ...
      <div className="relative h-[620px] md:h-[550px] flex items-center justify-center mb-20">
