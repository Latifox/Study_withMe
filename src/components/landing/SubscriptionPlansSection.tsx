...
const SubscriptionPlansSection = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24 relative">
      <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl shadow-xl hover:shadow-2xl transition-shadow mx-auto max-w-3xl mb-16 relative before:absolute before:inset-0 before:rounded-xl before:p-[2px] before:bg-gradient-to-r before:from-indigo-500 before:via-orange-500 before:to-cyan-500 before:-z-10">
