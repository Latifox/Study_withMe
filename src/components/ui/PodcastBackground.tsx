...
interface PodcastBackgroundProps {
  children: React.ReactNode;
}

const PodcastBackground = ({ children }: PodcastBackgroundProps) => {
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* Background gradient container with warm educational colors - matches StoryContent */}
      <div 
